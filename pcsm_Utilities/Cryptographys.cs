...
namespace pcsm_Utilities
{
    ...
    {
        static string passPhrase = "passPhrase4eFrom2290";        // can be any string
        static string saltValue = "saltVal4eForm2290";           // can be any string
        ...
        public static string Decrypt(string cipherText)
        {
            ...
            {
                string a = ex.Message;
                // clsLogger.Write(Convert.ToString(HttpContext.Current.Session["userId"]), ex.ToString());
            }
